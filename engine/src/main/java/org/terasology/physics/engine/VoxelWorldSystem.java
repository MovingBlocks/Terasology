            ...
            for (int y = 0; y < ChunkConstants.SIZE_Y; ++y) {
                for (int z = 0; z < ChunkConstants.SIZE_Z; ++z) {
                    ...
                    if (!registred.contains(id)) {
                        ...
                        btVoxelInfo info = new btVoxelInfo(shape != null && block.isTargetable(), shape != null && !block.isPenetrable(), id, shape, block.getCollisionOffset(), block.getFriction(), block.getRestitution(), block.getFriction());
