...
public class VoxelBlockWorld extends VoxelWorld {

    private VoxelBlockWorld(VoxelCollisionAlgorithmWrapper wrapper, BlockManager blockManager) {
        super(wrapper, blockManager);
    }

    public static VoxelBlockWorld create(BulletPhysics bulletPhysics, BlockManager blockManager) {
        ...
        discreteDynamicsWorld.addRigidBody(rigidBody, bulletPhysics.combineGroups(StandardCollisionGroup.WORLD), mask); // adds rigid body to world
        return new VoxelBlockWorld(wrapper, blockManager);
    }
}
