...
public class BlockPlacedMetric extends Metric {

    public static final String SCHEMA_BLOCK_PLACED = "iglu:org.terasology/blockDestroyed/jsonschema/1-0-0";
    ...
    public Map<String, ?> getFieldValueMap() {
        ...
        if (playerEntity.hasComponent(GamePlayStatsComponent.class)) {
            ...
            return gamePlayStatsComponent.blockPlacedMap;
        } else {
            return null;
        }
    }
