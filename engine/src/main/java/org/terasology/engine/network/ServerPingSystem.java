...
public class ServerPingSystem extends BaseComponentSystem implements UpdateSubscriberSystem {
    ...
    private final Map<EntityRef, Instant> startMap = new HashMap<>();

    private final Map<EntityRef, Instant> endMap = new HashMap<>();

    private final Map<EntityRef, Long> pingMap = new HashMap<>();
