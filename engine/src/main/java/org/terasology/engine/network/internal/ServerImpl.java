...
public class ServerImpl implements Server {
    ...
    private final NetMetricSource metricsSource;
    private final BlockingQueue<NetData.NetMessage> queuedMessages = Queues.newLinkedBlockingQueue();
    ...
    private final BlockingQueue<Chunk> chunkQueue = Queues.newLinkedBlockingQueue();
    private final TIntSet netDirty = new TIntHashSet();
    private final SetMultimap<Integer, Class<? extends Component>> changedComponents = HashMultimap.create();
    private final ListMultimap<Vector3i, NetData.BlockChangeMessage> awaitingChunkReadyBlockUpdates = ArrayListMultimap.create();
    private final ListMultimap<Vector3i, NetData.ExtraDataChangeMessage> awaitingChunkReadyExtraDataUpdates = ArrayListMultimap.create();
