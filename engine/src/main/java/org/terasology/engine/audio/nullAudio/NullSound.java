...
public class NullSound extends StaticSound {
    ...
    public NullSound(ResourceUrn urn, AssetType<?, StaticSoundData> assetType, int channels, int sampleRate,
                     float length) {
        super(urn, assetType);
    ...
    @Override
    protected Optional<? extends Asset<StaticSoundData>> doCreateCopy(ResourceUrn instanceUrn, AssetType<?,
            StaticSoundData> parentAssetType) {
