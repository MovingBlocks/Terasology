...
/**
 * This event is sent whenever a sound is to be played. The event is not sent to or played for the client of the entity
 * that sent the event as they have simulated it already.
 */
