 ...
 * <br><br>
 * How to use:<br> 1. Create OggInputStream passing in the input stream of the packed ogg file<br> 2. Fetch format and
 * sampling rate using getFormat() and getRate(). Use it to initialize the sound player.<br> 3. Read the PCM data using
 * one of the read functions, and feed it to your player.
 * <br><br>
...
public class OggReader extends FilterInputStream {
    ...
    /**
     * Helper function. Decodes a packet to the convbuffer if it is empty. Updates convbufferSize, convbufferOff, and
     * eos.
     */
     ...
     * up skipping over some smaller number of bytes, possibly 0. The actual number of bytes skipped is returned.
     *
