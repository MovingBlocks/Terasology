...
public interface SoundSource<T extends Sound<?>> {
    ...
    /**
     * Set sound source absolute positioning. This means sound source position would be updated on listener move
     *
     * @param absolute
     * @return
     */
    ...
    /**
     * Set sound source velocity Sound source velocity used for doppler effect calculation
     *
     * @param velocity
    ...
    /**
     * Set sound source looping WARNING! This will cause UnsupportedOperationException on streaming sounds
     *
     * @param looping
     * @return the sound source
     */
