...
public class ParticleUpdaterImpl implements ParticleUpdater {
     ...
     */
    private final BiMap<Class<? extends Component>, GeneratorFunction> registeredGeneratorFunctions = HashBiMap.create();

    /**
     * Map of Affectors to the functions that process them.
     */
    private final BiMap<Class<? extends Component>, AffectorFunction> registeredAffectorFunctions = HashBiMap.create();
