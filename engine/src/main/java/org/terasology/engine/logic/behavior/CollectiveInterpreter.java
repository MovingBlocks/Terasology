...
/**
 * Evaluates a behavior tree for a group of actors. This is necessary for synchronized behavior changes on each step.
 * Uses BehaviorTreeRunner to actually evaluate the tree. The runner is kept up to date when there are modifications at
 * the tree. *
 */
@API
