 ...
 * <br><br>
 * If there are both, Nodes and Renderables tree, both are loaded/saved. To ensure, the nodes get associated to the
 * correct renderable, additional ids are introduced (only in the json file).
 * <br><br>
 */
