...
public class ServerCharacterPredictionSystem extends BaseComponentSystem implements UpdateSubscriberSystem,
    ...
    private final Map<EntityRef, CircularBuffer<CharacterStateEvent>> characterStates = Maps.newHashMap();
    private final List<EntityRef> characterStatesToRemove = Lists.newArrayList();
    private final Map<EntityRef, CharacterMoveInputEvent> lastInputEvent = Maps.newHashMap();
