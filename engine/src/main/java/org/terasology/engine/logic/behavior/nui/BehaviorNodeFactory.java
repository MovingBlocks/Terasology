...
public class BehaviorNodeFactory extends BaseComponentSystem {
    ...
    private final List<BehaviorNodeComponent> nodeComponents = Lists.newArrayList();
    private final Map<String, List<BehaviorNodeComponent>> categoryComponents = Maps.newHashMap();
    ...
    private final List<ResourceUrn> sounds = Lists.newArrayList();
    private final List<ResourceUrn> music = Lists.newArrayList();
    ...
    private void refreshPrefabs() {
        ...
        if (prefabs.size() == 0) {
            ...
            List<String> nodes = Arrays.asList(
                    ...
                    "fail", "parallel", "playMusic", "playSound", "running", "selector", "setAnimation", "sequence", 
                    "succeed");
