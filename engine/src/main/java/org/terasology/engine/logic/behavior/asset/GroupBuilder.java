...
/**
 * This class is responsible for implementing the serialization functionality required by the Group asset class to load
 * group information from .group asset files.
 *
 * @see Group
 */
@API
