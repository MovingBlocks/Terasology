 ...
 * <p>
 * System should react on this to update logic or components according to the new size. Receiving this event denotes
 * that the scaling was "accepted" and should now be performed by systems.
 * <p>
