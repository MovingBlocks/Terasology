...
public class LocalPlayerSystem extends BaseComponentSystem implements UpdateSubscriberSystem, RenderSystem {
    ...
    // Input
    private final Vector3f relativeMovement = new Vector3f();
    ...
    public void update(float delta) {
        ...
        if (localPlayerInitialized) {
            ...
            updateCamera(characterMovementComponent, localPlayer.getViewPosition(),
                    JomlUtil.from(localPlayer.getViewRotation()));
        }
    }
