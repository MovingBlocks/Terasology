...
/**
 * This component  complements GroupTagComponent in cases where there's the need of an unison behavior by all entities
...
public class GroupMindComponent implements Component {
    ...
    /**
     * The name of the behavior tree used by the group (trees from other modules can be used as long as they are listed
     * as dependencies).
     */
