...
public final class MethodCommand extends AbstractCommand {
    ...
    /**
     * Creates a new {@code ReferencedCommand} to a specific method annotated with {@link
    ...
    /**
     * Registers all available command methods annotated with
     * {@link org.terasology.logic.console.commandSystem.annotations.Command}.
     */
