...
public final class CharacterComponent implements Component {
    ...
    /**
     * Specifies the maximium range at which this character is able to interact with other objects. When the player
     * leaves the range the interaction gets canceled.
     */
    ...
    /**
     * This field is only set for clients (including clients that are servers). The clients set it best to their
     * knowledge.
     * <br><br>
     * The events {@link org.terasology.logic.characters.interactions.InteractionStartPredicted} and {@link
     * org.terasology.logic.characters.interactions.InteractionEndPredicted} inform about changes of this field.
     */
