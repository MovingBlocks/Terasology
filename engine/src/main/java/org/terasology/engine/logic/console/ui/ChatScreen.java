...
public class ChatScreen extends CoreScreenLayer {
    ...
    private final InteractionListener screenListener = new BaseInteractionListener() {
        @Override
    ...
    public void initialise() {
        ...
        commandLine.subscribe(widget -> {
            ...
            if (StringUtils.isNotBlank(text)) {
                ...
                commandLine.setText("");
                scrollArea.moveToBottom();
                NotificationOverlay overlay = nuiManager.addOverlay(NotificationOverlay.ASSET_URI,
                        NotificationOverlay.class);
        ...
        history.bindText(new ReadOnlyBinding<String>() {
            @Override
            public String get() {
                Iterable<Message> messageIterable = console.getMessages(CoreMessageType.CHAT,
                        CoreMessageType.NOTIFICATION);
