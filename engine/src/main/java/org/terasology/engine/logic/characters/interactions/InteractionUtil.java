...
public final class InteractionUtil {
    ...
    /**
     * This method can be used by clients to request the cancelation of an interaction. The client will update it's
     */
    ...
    /**
     * @return the active interaction screen uri of the specified character. The method returns null if the player has
     *         no interaction screen open. The method is only intended to be called for the own character.
     */
