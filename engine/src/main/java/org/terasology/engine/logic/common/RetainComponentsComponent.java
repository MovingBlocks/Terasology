 ...
 * and block items.
 * <p>
 * If a block (item) entity has a component that is not part of its prefab, retaining this component results in the
 * block entity still having this component afterwards. If not retained, it is likely to be removed instead.
 */
