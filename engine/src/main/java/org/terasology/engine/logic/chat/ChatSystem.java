    ...
    public String whisper(
        ...
        for (EntityRef client : clients) {
            ...
            DisplayNameComponent displayNameComponent =
                    clientComponent.clientInfo.getComponent(DisplayNameComponent.class);
            ...
            for (EntityRef client : clients) {
                ...
                if (displayNameComponent.name.equals(username)) {
                    if (targetClient == null) {
                        ...
                        return FontColor.getColored("Found more users with name '" + username + "'.",
                                ConsoleColors.ERROR);
                    }
                }
            }
        ...
        DisplayNameComponent targetDisplayNameComponent =
                targetClientComponent.clientInfo.getComponent(DisplayNameComponent.class);
