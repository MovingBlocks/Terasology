 ...
 * Condition leaf node.
 * <p>
 * Checks for specific conditions on Components of a given Entity. If componentPresent is specified, checks that the
 * component is present. If componentAbsent is specified, checks that the component is absent. if the 'values' field is
 * specified, checks the values
 * <p>
...
public class ConditionAction extends BaseAction {
    ...
    public BehaviorState modify(Actor actor, BehaviorState result) {
        try {
            ...
            logger.error("Field not found. Does the field specified in 'values' (publicly) exist in the Component " +
                    "specified in 'componentPresent'?", e);
    ...
    protected boolean condition(Actor actor) throws ClassNotFoundException, NoSuchFieldException,
                ...
                if (values != null) {
                    for (String value : values) {
                        ...
                        switch (tokens[0]) {
                            ...
                            case "F":
                                secondValue =
                                        component.getClass().getDeclaredField(tokens[3]).get(component).toString();
                                break;
                        ...
                        if (fieldValue instanceof Boolean) {
                            ...
                            if (fieldValue == null) {
                                ...
                                switch (tokens[2]) {
                                    ...
                                    default:
                                        logger.error("Unknown field type or operation: {} {}", fieldValue.getClass(),
                                                tokens[2]);
                                }
                            }
                        }
