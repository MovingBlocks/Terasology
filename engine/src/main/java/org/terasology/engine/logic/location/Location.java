...
public class Location extends BaseComponentSystem {
    ...
    /**
     * Attaches an entity to another entity. Both must have location components. This method sets the child's relative
     * offset and rotation to the parent {@link LocationComponent}
     *
     ...
     *         {@link #attachChild(EntityRef, EntityRef, Vector3fc, Quaternionfc, float)}.
     */
    @Deprecated
     ...
     * @param relativeRotation relative rotation from parent
     * @deprecated This is scheduled for removal in an upcoming version method will be replaced with JOML implementation
     *         {@link #attachChild(EntityRef, EntityRef, Vector3fc, Quaternionfc)}.
     */
    @Deprecated
    public static void attachChild(EntityRef parent, EntityRef child, Vector3f offset, Quat4f relativeRotation) {
    ...
    /**
     * Attaches an entity to another entity. Both must have location components. The child maintains its previous
     * position and rotation but follows the parent.
     *
     * @param parent
     * @param child
     */
