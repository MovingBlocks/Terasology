...
public class InteractionSystem extends BaseComponentSystem {
    ...
    public void onInteractionEnd(InteractionEndEvent event, EntityRef character,
    ...
    public void onScreenLayerClosed(ScreenLayerClosedEvent event, EntityRef container,
