...
public class ModuleConfigSystem extends BaseComponentSystem implements ModuleConfigManager {
    ...
    private final Map<String, Map<String, String>> propertiesPerModule = new HashMap<>();
    ...
    private <T> T getVariable(String moduleName, String propertyName, Function<String, T> extractFunction,
                              T defaultValue) {
