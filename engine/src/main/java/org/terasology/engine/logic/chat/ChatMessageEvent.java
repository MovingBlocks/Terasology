 ...
 * <p>
 * Needs to be sent against a client entity, e.g., the targeted entity should have a {@link
 * org.terasology.network.ClientComponent}.
 */
@OwnerEvent
public class ChatMessageEvent implements MessageEvent {
     ...
     * <p>
     * This entity may often be a player, but it can be any entity with a
     * {@link org.terasology.logic.common.DisplayNameComponent}.
