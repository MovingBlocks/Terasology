...
public class MovementDebugCommands extends BaseComponentSystem {
    ...
    public String pushCharacterCommand(@Sender EntityRef sender,
                                       @CommandParam("x") float x, @CommandParam("y") float y,
    ...
    public String showHeight(@Sender EntityRef client) {
        ...
        GazeMountPointComponent gazeMountPointComponent =
                clientComp.character.getComponent(GazeMountPointComponent.class);
    ...
    public String playerEyeHeight(@Sender EntityRef client, @CommandParam("eye-height") float amount) {
        ...
        try {
            ...
            if (gazeMountPointComponent != null) {
                ...
                Location.attachChild(player, gazeMountPointComponent.gazeEntity, gazeMountPointComponent.translate,
                        new Quaternionf());
    ...
    @Command(value = "teleport", shortDescription = "Teleports you to a location", runOnServer = true,
            requiredPermission = PermissionManager.CHEAT_PERMISSION)
    public String teleportCommand(@Sender EntityRef sender, @CommandParam("x") float x, @CommandParam("y") float y,
                                  @CommandParam("z") float z) {
    ...
    @Command(shortDescription = "Teleport User1 to User2", runOnServer = true,
            requiredPermission = PermissionManager.USER_MANAGEMENT_PERMISSION)
    public String teleportPlayerToPlayer(@CommandParam("usernameFrom") String usernameFrom, @CommandParam("usernameTo"
    ) String usernameTo) {
    ...
    @Command(shortDescription = "Teleport all users to location", runOnServer = true,
            requiredPermission = PermissionManager.USER_MANAGEMENT_PERMISSION)
    public String teleportAllPlayersToLocation(@CommandParam("x") float x, @CommandParam("y") float y, @CommandParam(
            "z") float z) {
    ...
    public String teleportAllPlayersToPlayer(@CommandParam("username") String username) {
        ...
        if (clientInfo != null) {
            CharacterMovementComponent playerMovementComponent =
                    clientInfo.character.getComponent(CharacterMovementComponent.class);
        ...
        for (EntityRef clientEntity : entityManager.getEntitiesWith(ClientComponent.class)) {
            ...
            if (clientComp != null) {
                ...
                CharacterMovementComponent characterMovementComponent =
                        clientComp.character.getComponent(CharacterMovementComponent.class);
