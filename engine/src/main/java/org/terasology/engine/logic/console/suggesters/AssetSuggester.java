...
/**
 * Suggest asset names. When only one asset resource exists for the entire set of loaded modules, the name alone
 * suffices. Otherwise, the module name must be prepended.
 */
