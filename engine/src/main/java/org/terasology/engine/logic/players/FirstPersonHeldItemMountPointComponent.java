...
public class FirstPersonHeldItemMountPointComponent implements Component {
    ...
    private final Matrix4f toolAdjustmentMatrix = new Matrix4f(
            1.0f, 0.0f, 0.0f, 0.0f,
    ...
    /**
     * Sometimes, a tracking system (i.e. for room-scale VR) provides a pose for this mount point. In this case, special
     * handling is necessary, and this accessor gives a way to check.
     *
    ...
    public void poseChanged(Matrix4f pose, int handIndex) {
        ...
        org.joml.Vector4f jomlQuaternion = org.terasology.rendering.openvrprovider.OpenVRUtil.convertToQuaternion
        (adjustedPose);
