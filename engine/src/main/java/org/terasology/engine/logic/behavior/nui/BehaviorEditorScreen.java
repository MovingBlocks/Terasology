...
public class BehaviorEditorScreen extends CoreScreenLayer {
    ...
    public void initialise() {
        ...
        behaviorEditor.bindSelection(new Binding<RenderableNode>() {
            private final PropertyProvider provider = new PropertyProvider(context.get(ReflectFactory.class),
                    providerFactory);
        ...
        if (selectedNode != null) {
            nuiManager.pushScreen("engine:enterTextPopup", EnterTextPopup.class).bindInput(new Binding<String>() {
                ...
                public void set(String value) {
                    BehaviorEditorScreen.this.behaviorSystem.createTree(value,
                            BehaviorEditorScreen.this.selectedNode.getNode());
                }
            });
        }
    }
    ...
    private void onNodeSelected(RenderableNode value, PropertyProvider provider) {
        ...
        if (value != null) {
            ...
            if (underlyingNode instanceof ActionNode) {
                this.properties.addProperties("Behavior Node",
                        provider.createProperties(((ActionNode) underlyingNode).getAction()));
            }
