...
/**
 * This event gets sent when the player spawns. <br/>
 * <b>Note:</b> that this should be used only as a one time event i.e. when
 * the player spawns for the first time in the game. On every subsequent spawn a onPlayerRespawnedEvent is sent.
 */
