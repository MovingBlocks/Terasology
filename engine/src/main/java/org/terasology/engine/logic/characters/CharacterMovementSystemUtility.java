...
public final class CharacterMovementSystemUtility {
    ...
    /**
     * Sets the state of the given entity to the state represented by the CharacterStateEvent. The state of the entity
     * is determined by its LocationComponent (location and orientation of physics body), CharacterMovementComponent
     * (velocity and various movement state variables) and CharacterComponent for pitch and yaw (used for the camera).
     *
     * @param entity
     * @param state
     */
