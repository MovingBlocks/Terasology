...
/**
 * This class is responsible for associating the correct file extensions (.group) with the Group asset class. It is also
 * the actual responsible for invoking the serialization method from the builder class.
 *
 * @see Group
 * @see GroupBuilder
 */
