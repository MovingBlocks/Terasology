 ...
 * instance. There is only one action instance for all actors, that run a behavior tree - so all state information needs
 * to be stored at the actor.
 * <p/>
...
public interface Action {
    ...
    /**
     * Is called when the action node is deconstructed on last update tick (when state switches from RUNNING to anything
     * else)
     */
