...
class EntitySetDeltaRecorder {
    ...
    private final TLongObjectMap<EntityDelta> entityDeltas = new TLongObjectHashMap<>();
    private final TLongSet destroyedEntities = new TLongHashSet();
    private final TLongSet deactivatedEntities = new TLongHashSet();
    /**
     ...
     * */
    private final Map<Object, DelayedEntityRef> delayedEntityRefs =  new MapMaker().weakValues().makeMap();
