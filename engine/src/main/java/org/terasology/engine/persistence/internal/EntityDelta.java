...
public class EntityDelta {
    private final Set<Class<? extends Component>> removedComponents = Sets.newHashSet();
    private final Map<Class<? extends Component>, Component> changedComponents = Maps.newHashMap();
