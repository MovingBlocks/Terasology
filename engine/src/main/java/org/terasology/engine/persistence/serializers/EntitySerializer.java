...
import static org.terasology.engine.protobuf.EntityData.Entity.Scope.CHUNK;
import static org.terasology.engine.protobuf.EntityData.Entity.Scope.GLOBAL;
import static org.terasology.engine.protobuf.EntityData.Entity.Scope.SECTOR;
    ...
    private void deserializeOntoComponents(EntityData.Entity entityData, Map<Class<? extends Component>, Component> componentMap) {
        ...
        for (EntityData.Component componentData : entityData.getComponentList()) {
            ...
            if (existingComponent == null) {
                ...
                componentSerializer.deserializeOnto(existingComponent, componentData, FieldSerializeCheck.NullCheck.newInstance());
            }
        }
    }
