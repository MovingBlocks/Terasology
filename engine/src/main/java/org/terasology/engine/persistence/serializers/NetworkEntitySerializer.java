...
import org.terasology.engine.persistence.typeHandling.Serializer;
...
public class NetworkEntitySerializer {
    ...
    private final ProtobufPersistedDataSerializer serializationContext;
    ...
    public void deserializeOnto(MutableComponentContainer entity, EntityData.PackedEntity entityData) {
        deserializeOnto(entity, entityData, FieldSerializeCheck.NullCheck.newInstance());
    }
