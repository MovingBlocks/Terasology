...
final class EntityStorer {
    ...
    private final Set<EntityRef> storedEntities = Sets.newHashSet();
    ...
    public void store(EntityRef entity, String name) {
        if (entity.isActive()) {
            ...
            EntityData.Entity entityData = serializer.serialize(entity, true, FieldSerializeCheck.NullCheck.newInstance());
