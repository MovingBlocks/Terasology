...
public class HUDScreenLayer extends CoreScreenLayer {
    ...
    private final Map<ResourceUrn, HUDElement> elementsLookup = Maps.newLinkedHashMap();
    ...
    public Iterator<UIWidget> iterator() {
        return new Iterator<UIWidget>() {
            private final Iterator<HUDElement> elementIterator = elementsLookup.values().iterator();
