...
public class FontDataBuilder {
    ...
    private final TIntObjectMap<Texture> pages = new TIntObjectHashMap<>();
    private final TIntObjectMap<Material> pageMats = new TIntObjectHashMap<>();
    private final Map<Integer, FontCharacter> characters = Maps.newHashMap();
