...
import org.terasology.engine.logic.location.DistanceComparator;
...
public class NearestSortingList implements Iterable<EntityRef> {
    ...
    private class SortTask extends TimerTask {
        ...
        private final Camera originCamera;
