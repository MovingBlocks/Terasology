...
public class FontFormat extends AbstractAssetFileFormat<FontData> {
    ...
    // Common patterns
    private final Pattern lineHeightPattern = Pattern.compile("lineHeight=" + INTEGER_PATTERN);
    private final Pattern baseHeightPattern = Pattern.compile("base=" + INTEGER_PATTERN);
    private final Pattern pagesPattern = Pattern.compile("pages=" + INTEGER_PATTERN);

    private final Pattern pagePattern = Pattern.compile("page id=" + INTEGER_PATTERN + " file=\"(.*)\"");
    private final Pattern charsPattern = Pattern.compile("chars count=" + INTEGER_PATTERN);
    private final Pattern charPattern = Pattern.compile("char\\s+" +
