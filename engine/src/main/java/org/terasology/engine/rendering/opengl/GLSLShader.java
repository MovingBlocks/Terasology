...
public class GLSLShader extends Shader {
    ...
    static {
        try (
                InputStreamReader vertStream = getInputStreamReaderFromResource("org/terasology/engine/include" +
                        "/globalFunctionsVertIncl.glsl");
                InputStreamReader fragStream = getInputStreamReaderFromResource("org/terasology/engine/include" +
                        "/globalFunctionsFragIncl.glsl");
                InputStreamReader uniformsStream = getInputStreamReaderFromResource("org/terasology/engine/include" +
                        "/globalUniformsIncl.glsl");
                InputStreamReader definesStream = getInputStreamReaderFromResource("org/terasology/engine/include" +
    ...
    private final EnumSet<ShaderProgramFeature> availableFeatures = Sets.newEnumSet(Collections.emptyList(),
            ShaderProgramFeature.class);
    private ShaderData shaderProgramBase;
    private final Map<String, ShaderParameterMetadata> parameters = Maps.newHashMap();
