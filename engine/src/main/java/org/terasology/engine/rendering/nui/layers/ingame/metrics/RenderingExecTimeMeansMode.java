...
public class RenderingExecTimeMeansMode extends MetricsMode {
    ...
    private final ArrayList<MetricsEntry> processedEntries = new ArrayList<>();
    private final AlphabeticalAscendingComparator inAscendingAlphabeticalOrder = new AlphabeticalAscendingComparator();

    private final TObjectDoubleProcedure<String> matchingCriteria = new FilterByStartWith();
    private final EntryAdder addEntryToProcessedEntries = new EntryAdder();
