...
public class OpenVRState {
    ...
    // Controllers
    private static final Matrix4f[] controllerPose = new Matrix4f[2];
    private static final VRControllerState_t[] lastControllerState = new VRControllerState_t[2];

    private final List<ControllerListener> controllerListeners = new ArrayList<>();

    // In the head frame
    private final Matrix4f[] eyePoses = new Matrix4f[2];
    private final Matrix4f[] projectionMatrices = new Matrix4f[2];
