...
public class BrowserWidget extends CoreWidget {
    ...
    private final List<BrowserHyperlinkListener> listenerList = new LinkedList<>();

    private final List<HyperlinkBox> hyperlinkBoxes = new LinkedList<>();
    private final ParagraphRenderable.HyperlinkRegister register = new HyperlinkRegisterImpl();
