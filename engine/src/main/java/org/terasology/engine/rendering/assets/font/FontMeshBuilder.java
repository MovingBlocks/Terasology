...
public class FontMeshBuilder {
    ...
    private class Builder {
        ...
        private final boolean baseUnderline;

        private final Map<Material, MeshBuilder> meshBuilders = Maps.newLinkedHashMap();
        ...
        private final Deque<Colorc> previousColors = new ArrayDeque<>();
