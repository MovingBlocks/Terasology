...
public class NUIEditorMenuTreeBuilder {
    ...
    private final Logger logger = LoggerFactory.getLogger(NUIEditorMenuTreeBuilder.class);
     ...
     */
    private final Map<String, Consumer<JsonTree>> externalConsumers = Maps.newHashMap();
    /**
     * Listeners fired when one of the options within {@code LEVEL_ADD_EXTENDED} is selected.
     */
    private final List<Consumer<JsonTree>> addContextMenuListeners = Lists.newArrayList();
