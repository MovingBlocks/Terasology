...
public class Tessellator {
    ...
    private final Vector4f activeColor = new Vector4f();
    private final Vector3f activeNormal = new Vector3f();
    private final Vector2f activeTex = new Vector2f();
    private final Vector3f lighting = new Vector3f();
