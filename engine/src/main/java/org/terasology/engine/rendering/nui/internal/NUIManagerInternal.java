...
public class NUIManagerInternal extends BaseComponentSystem implements NUIManager, PropertyChangeListener {
    private final Logger logger = LoggerFactory.getLogger(NUIManagerInternal.class);
    private Deque<UIScreenLayer> screens = Queues.newArrayDeque();
    private final HUDScreenLayer hudScreenLayer;
    private final BiMap<ResourceUrn, UIScreenLayer> screenLookup = HashBiMap.create();
    ...
    private final Map<ResourceUrn, ControlWidget> overlays = Maps.newLinkedHashMap();
