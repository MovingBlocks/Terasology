...
import org.terasology.engine.math.MatrixUtils;
...
public class GLSLMaterial extends BaseMaterial {
    ...
    private final TObjectIntMap<String> bindMap = new TObjectIntHashMap<>();
    private final TIntObjectMap<Texture> textureMap = new TIntObjectHashMap<>();
    private GLSLShader shader;
    private boolean activeFeaturesChanged;
    private final TObjectIntMap<UniformId> uniformLocationMap = new TObjectIntHashMap<>();
    private final EnumSet<ShaderProgramFeature> activeFeatures = Sets.newEnumSet(Collections.emptyList(),
    ...
    private static class DisposalAction implements DisposableResource {
        ...
        private final TIntIntMap shaderPrograms = new TIntIntHashMap();
