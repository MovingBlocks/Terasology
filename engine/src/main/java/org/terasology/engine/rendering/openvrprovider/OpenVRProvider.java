...
import static org.terasology.engine.rendering.openvrprovider.ControllerListener.LEFT_CONTROLLER;
import static org.terasology.engine.rendering.openvrprovider.ControllerListener.RIGHT_CONTROLLER;
...
public final class OpenVRProvider {
    ...
    private static final int[] controllerDeviceIndex = new int[2];
    private static final VRControllerState_t.ByReference[] inputStateRefernceArray = new VRControllerState_t.ByReference[2];
    private static final VRControllerState_t[] controllerStateReference = new VRControllerState_t[2];
    private static IntBuffer hmdErrorStore;
    private static TrackedDevicePose_t.ByReference hmdTrackedDevicePoseReference;
    private static TrackedDevicePose_t[] hmdTrackedDevicePoses;
    private static final boolean[] controllerTracking = new boolean[2];
