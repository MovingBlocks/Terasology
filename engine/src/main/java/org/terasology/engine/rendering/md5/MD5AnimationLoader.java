...
public class MD5AnimationLoader extends AbstractAssetFileFormat<MeshAnimationData> {
    ...
    private final Pattern doubleVectorPattern = Pattern.compile(MD5Patterns.VECTOR3_PATTERN +
            "\\s*" + MD5Patterns.VECTOR3_PATTERN);
    private final Pattern frameStartPattern = Pattern.compile("frame " + MD5Patterns.INTEGER_PATTERN + " \\{");
