...
public class SkeletalMeshData implements AssetData {
    ...
    private final Map<String, Bone> boneLookup = Maps.newHashMap();
    private final List<Bone> bones = Lists.newArrayList();
    private List<Vector2f> uvs = ImmutableList.of();
    private final List<BoneWeight> weights = Lists.newArrayList();
    private final TIntList vertexStartWeights = new TIntArrayList();
    private final TIntList vertexWeightCounts = new TIntArrayList();
    private final TIntList indices = new TIntArrayList();
    private final AABB staticAABB;
