...
public class PerspectiveCamera extends SubmersibleCamera implements PropertyChangeListener {
    ...
    private final Deque<Vector3f> previousPositions = new LinkedList<>();
    private final Deque<Vector3f> previousViewingDirections = new LinkedList<>();

    private final float multiplier = 0.9f;
    ...
    private final Vector3f tempRightVector = new Vector3f();
