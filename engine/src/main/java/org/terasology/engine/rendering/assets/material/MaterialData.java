...
public class MaterialData implements AssetData {
    ...
    private final Map<String, Float> floatParams = Maps.newHashMap();
    private final Map<String, float[]> floatArrayParams = Maps.newHashMap();
    private final Map<String, Integer> intParams = Maps.newHashMap();
