...
public class BulletPhysics implements PhysicsEngine {
    ...
    private final Map<EntityRef, BulletRigidBody> entityRigidBodies = Maps.newHashMap();
    private final Map<EntityRef, BulletCharacterMoverCollider> entityColliders = Maps.newHashMap();
    private final Map<EntityRef, PairCachingGhostObject> entityTriggers = Maps.newHashMap();
