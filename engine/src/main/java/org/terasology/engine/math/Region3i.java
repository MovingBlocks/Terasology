 ...
 *
 * @deprecated This method is scheduled for removal in an upcoming version. Use the JOML implementation instead: {@link
...
public final class Region3i implements Iterable<Vector3i> {
    ...
    /**
     * @deprecated As of 24 sep 2018, because it is error prone. Everyone can change this instance and destroy the
     *         invariant properties. Some methods used to return this instance silently on special cases.
     */
    @Deprecated
     ...
     *         {@link org.terasology.world.block.BlockRegionIterable}.
     */
    @Deprecated
    ...
    /**
     * @param other
     * @return The region that is encompassed by both this and other. If they do not overlap then the empty region is
     *         returned
     */
    ...
    private class SubtractiveIterator implements Iterator<Vector3i> {
        private final Iterator<Vector3i> innerIterator;
        private Vector3i next;
        private final Region3i other;
