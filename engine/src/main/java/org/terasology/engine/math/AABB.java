...
public final class AABB {
     ...
     *
     * @param vertices The vertices to encompass. It is assumed that the X, Y, Z components of each vertex are
     *         stored consecutively in the {@link TFloatList}.
     *         <p>
     *         For the {@code i}th vertex in the list, the X, Y, and Z components are stored at indices {@code 3 * i},
     *         {@code 3 * i + 1}, and {@code 3 * i + 2} respectively.
     * @return The created AABB.
     */
    ...
    /**
     * Transform this AABB into a new AABB with the given rotation, offset and scale as represented by the {@link
     * Transform}.
     *
     * @param transform The {@link Transform} representing the offset, rotation, and scale transformation from
     *         this AABB to the new AABB.
     * @return the new transformed AABB.
     */
     ...
     * @return The normal
     */
    public Vector3f normalForPlaneClosestToOrigin(Vector3f pointOnAABB, Vector3f origin, boolean testX, boolean testY
            , boolean testZ) {
