...
/**
 * Diamond3Iterable iterates in a diamond shape hull where the manhattan distance is the same for that level. for each
 * group of iterations the manhattan distance decreases. inner and outer radiuses can be set where the shape can be an
 * hull with distance 1 to a full solid.
 */
