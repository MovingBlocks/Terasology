...
/**
 * An {@link Iterable} that iterates in a square-shapes spiral around the central point (inclusive).
 * <br><br>
...
public class SpiralIterable implements Iterable<Vector2ic> {
    ...
    /**
     * Iterates in clock-wise orientation around the given point. The point will be the first iterated point.
     *
     * @param center the spiral center
     */
