...
public interface ClassMetaLibrary {
     ...
     * @return All types in the environment that are either marked by the given annotation, or are subtypes of a type
     *         marked with the annotation if the annotation is marked as @Inherited
     */
