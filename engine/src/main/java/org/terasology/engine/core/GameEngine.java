...
public interface GameEngine {
    ...
    /**
     * Runs the engine, which will block the thread. Invalid for a disposed engine
     */
    ...
    /**
     * @return Whether the engine is running - this is true from the point run() is called to the point shutdown is
     *         complete
     */
    boolean isRunning();
    ...
    /**
     * Creates a context that provides read access to the objects of the engine context and can be populated with it's
     * own private objects.
     */
