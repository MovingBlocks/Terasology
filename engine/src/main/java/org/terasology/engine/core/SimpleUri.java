...
/**
 * A URI to identify standard objects in Terasology - components, events, etc. These URIs are always in the form:
 * {@literal <module-name>:<object-name>}. They are case-insensitive (using English casing), and have a "normalized"
 * form that is lower case.
 */
@API
public class SimpleUri implements Uri, Comparable<SimpleUri> {
    ...
    /**
     * Creates a SimpleUri from a string in the format "module:object". If the string does not match this format, it
