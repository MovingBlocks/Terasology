...
public final class TerasologyConstants {
    ...
    /**
     * Name of the engine module. The engine module contains engine features, without any gameplay elements. Examples of
     * specific features include the entity system, noise functions, core blocks, and utilities.
     */
     ...
     */
    public static final String ASSETS_SUBDIRECTORY = "org/terasology/engine/assets";
    /**
     * Name of a module's overrides directory. Overrides replace an entire existing prefab. More info on
     * Overrides/Deltas:
     * <a href="https://github.com/Terasology/TutorialAssetSystem/wiki/Deltas-and-Overrides">Deltas-and-Overrides</>
     */
    public static final String OVERRIDES_SUBDIRECTORY = "overrides";
    /**
     * Name of a module's deltas directory. Deltas of a prefab replace certain fields in an existing version of that
     * prefab with their own fields. More info on Overrides/Deltas:
     * <a href="https://github.com/Terasology/TutorialAssetSystem/wiki/Deltas-and-Overrides">Deltas-and-Overrides</>
     */
