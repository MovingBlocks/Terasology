...
public final class PathManager {
    ...
    private PathManager() {
        ...
        try {
            ...
            // Theory that whatever reason we needed to get the path that way isn't needed anymore - try just current
            // dir ...
    ...
    public void useDefaultHomePath() throws IOException {
        switch (LWJGLUtil.getPlatform()) {
            ...
            case LWJGLUtil.PLATFORM_MACOSX:
                homePath = Paths.get(System.getProperty("user.home"), "Library", "Application Support",
                        TERASOLOGY_FOLDER_NAME);
                break;
    ...
    /**
     * Updates all of the path manager's file/directory references to match the path settings. Creates directories if
