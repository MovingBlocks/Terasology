...
public class ModuleInstallManager {
    ...
    private final ModuleListDownloader remoteRegistryUpdater;
    ...
    public Callable<Void> updateRemoteRegistry() {
        return (() -> {
            ...
            downloadListGenerator = new ModuleDownloadListGenerator(moduleManager.getRegistry(),
                    new DependencyResolver(remoteRegistry));
            return null;
        });
    }
    ...
    public ModuleInstaller createInstaller(Iterable<Module> modules,
                                           MultiFileTransferProgressListener progressListener) {
