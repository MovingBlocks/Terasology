...
/**
 * Information and access to the GameThread - the main thread of Terasology. Certain updates can only occur on the
 * GameThread:
 * <ul>
 * <li>World changes</li>
...
public final class GameThread {
    ...
    private static final BlockingDeque<Runnable> pendingRunnables = Queues.newLinkedBlockingDeque();
