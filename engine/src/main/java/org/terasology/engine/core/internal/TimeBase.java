...
public abstract class TimeBase implements EngineTime {
    ...
    private final AtomicLong realDelta = new AtomicLong(0);
    private final AtomicLong gameDelta = new AtomicLong(0);
    private float frameDelta;
    private long desynch;
    private boolean paused;

    private final AtomicDouble gameDilation = new AtomicDouble(1.0f);

    private final AtomicLong gameTime = new AtomicLong(0);
