...
public class TerasologyEngine implements GameEngine {
    ...
    private void initAssets() {
        ...
        assetTypeManager.createAssetType(Prefab.class, PojoPrefab::new, "prefabs"); // TOOD check this asset (removed
        // boolean flag) - gestalt v7
        ...
        assetTypeManager.createAssetType(BehaviorTree.class, BehaviorTree::new, "behaviors"); // TODO check this
        // asset ( removed boolean flag) - gestalt v7
