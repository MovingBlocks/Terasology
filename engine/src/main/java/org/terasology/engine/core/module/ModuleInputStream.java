 ...
 * <p>
 * By using this class, the caller is not allowed to close the stream at all. For security reasons, only {@link
 * SandboxFileManager} have the permissions to close it, since the caller may completely forget to do so.
 */
@API
