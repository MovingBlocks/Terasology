...
public interface EngineSubsystem {
    ...
    /**
     * Called on each system before initialisation. This is an opportunity to add anything into the root context that
     * will carry across the entire rune of the engine, and may be used by other systems
     *
    ...
    /**
     * Called to register any core asset types this system provides. This happens after initialise and before
     * postInitialise
     *
