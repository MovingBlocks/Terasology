...
import org.terasology.rendering.headless.HeadlessFont;
...
public class HeadlessGraphics implements EngineSubsystem {
    ...
    public void initializeLate(Config config) {
        HeadlessDisplay headlessDisplay = new HeadlessDisplay();

        CoreRegistry.putPermanently(org.terasology.engine.subsystem.Display.class, headlessDisplay);
    ...
    private void initHeadless(HeadlessDisplay headlessDisplay) {
