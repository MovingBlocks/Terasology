...
/**
 * This system refreshes the translation system during the initialization, reloading the i18n files from the module
 * environment. The translation system by it's own is not refreshed, as it is an EngineSubsystem.
 */
@RegisterSystem
