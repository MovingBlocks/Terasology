 ...
 * </pre>
 * All IETF BCP 47 language tags are supported, but consider sticking to ISO 639-1 for simplicity. The data in the files
 * is expected to be JSON entries of the form of a &lt;String, String&gt; map.
 */
