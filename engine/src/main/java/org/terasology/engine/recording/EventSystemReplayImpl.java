...
public class EventSystemReplayImpl implements EventSystem {
    ...
    private final SetMultimap<Class<? extends Event>, EventSystemReplayImpl.EventHandlerInfo> generalHandlers = HashMultimap.create();
    private final Comparator<EventHandlerInfo> priorityComparator = new EventSystemReplayImpl.EventHandlerPriorityComparator();
    ...
    private final BlockingQueue<RecordedEvent> recordedEvents = Queues.newLinkedBlockingQueue();
    ...
    private final RecordedEventStore recordedEventStore;
    ...
    private final List<Class<?>> selectedClassesToReplay;
