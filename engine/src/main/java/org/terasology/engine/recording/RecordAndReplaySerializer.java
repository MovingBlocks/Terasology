...
public final class RecordAndReplaySerializer {
    ...
    private final CharacterStateEventPositionMap characterStateEventPositionMap;
    private final DirectionAndOriginPosRecorderList directionAndOriginPosRecorderList;
    private final RecordedEventSerializer recordedEventSerializer;
