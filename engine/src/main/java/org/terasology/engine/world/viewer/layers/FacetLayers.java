...
/**
 * Additional functionality around the {@link FacetLayer} interface that is independent from any actual implementation.
 */
public final class FacetLayers {
     ...
     */
    public static List<FacetLayer> createLayersFor(Set<Class<? extends WorldFacet>> facets,
