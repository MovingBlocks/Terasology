...
/**
 * TeraDenseArray16Bit implements a sparse array with elements of 16 bit size. Its elements are in the range -32'768
 * through +32'767 and it internally uses the short type to store its elements. It can reduce memory consumption through
...
public class TeraSparseArray16Bit extends TeraSparseArray {
    ...
    public TeraArray deflate(TeraVisitingDeflator deflator) {
        return Preconditions.checkNotNull(deflator).deflateSparseArray16Bit(inflated, deflated, fill, getSizeXZ(),
