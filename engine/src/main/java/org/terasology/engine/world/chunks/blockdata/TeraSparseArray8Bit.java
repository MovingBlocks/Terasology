...
/**
 * TeraSparseArray8Bit implements a sparse array with elements of 8 bit size. Its elements are in the range -128 through
 * +127 and it stores one element per byte. It can reduce memory consumption through sparse memory allocation.
 */
public final class TeraSparseArray8Bit extends TeraSparseArrayByte {
    ...
    public TeraArray deflate(TeraVisitingDeflator deflator) {
        return Preconditions.checkNotNull(deflator).deflateSparseArray8Bit(inflated, deflated, fill, rowSize(),
