...
public class SunlightRegenBatchPropagator implements BatchPropagator {
    ...
    private final PropagationRules regenRules;
    private final PropagatorWorldView regenWorld;
    private final PropagatorWorldView sunlightWorld;
    private final BatchPropagator sunlightPropagator;

    private final Set<Vector3i>[] reduceQueues;
    private final Set<Vector3i>[] increaseQueues;
