...
/**
 * TeraDenseArray8Bit implements a dense array with elements of 8 bit size. Its elements are in the range -128 through
 * +127 and it stores one element per byte.
 */
public final class TeraDenseArray8Bit extends TeraDenseArrayByte {
    ...
    public TeraArray deflate(TeraVisitingDeflator deflator) {
        return Preconditions.checkNotNull(deflator).deflateDenseArray8Bit(data, rowSize(), getSizeX(), getSizeY(),
                getSizeZ());
    }
