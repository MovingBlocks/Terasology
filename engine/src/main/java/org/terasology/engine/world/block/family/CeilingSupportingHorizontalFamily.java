 ...
 * <p>
 * The block will be placed upside down, if it's either being attached to a BOTTOM side (i.e. the ceiling), or if it's
 * being attached to the upper half of any horizontal side (LEFT, RIGHT, FRONT, BACK).
 */
...
public class CeilingSupportingHorizontalFamily extends AbstractBlockFamily {
    ...
    public CeilingSupportingHorizontalFamily(BlockFamilyDefinition definition, BlockShape shape,
     ...
     * <p>
     * These are all four 90 degree rotations about the Y-axis (YAW) for each case where the TOP side is - facing
     * upwards - facing downwards
     *
     ...
     */
    private void populateBlockMaps(BlockBuilderHelper blockBuilder, BlockShape shape,
                                   BlockFamilyDefinition definition, BlockUri uri) {
    ...
    /**
     * This enum encapsulates all rotations for upright and upside down positioning. The primary is either TOP or BOTTOM
     * and represents upright, or upside down positioning respectively. The rotation represent the horizontal direction
     * the block is facing.
     */
