...
/**
 * TeraDenseArray4Bit implements a dense array with elements of 4 bit size. Its elements are in the range 0 - 15 and it
 * increases memory efficiency by storing two elements per byte.
 */
public final class TeraDenseArray4Bit extends TeraDenseArrayByte {
    ...
    public TeraArray deflate(TeraVisitingDeflator deflator) {
        return Preconditions.checkNotNull(deflator).deflateDenseArray4Bit(data, rowSize(), getSizeX(), getSizeY(),
                getSizeZ());
    }
