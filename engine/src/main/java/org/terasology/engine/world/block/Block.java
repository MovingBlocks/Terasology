...
public final class Block {
    ...
    private final Vector3f tint = new Vector3f(0, 0, 0);
    ...
    private final Map<Side, BlockMeshPart> lowLiquidMesh = Maps.newEnumMap(Side.class);
    private final Map<Side, BlockMeshPart> topLiquidMesh = Maps.newEnumMap(Side.class);
    ...
    /**
     * @param meshGenerator The new BlockMeshGenerator to use in rendering this block. If meshGenerator is null
     *         then this block is invisible.
     */
    ...
    public void renderWithLightValue(float sunlight, float blockLight) {
        ...
        Material mat = Assets.getMaterial("engine:prog.block").orElseThrow(() -> new RuntimeException("Missing engine" +
                " material"));
