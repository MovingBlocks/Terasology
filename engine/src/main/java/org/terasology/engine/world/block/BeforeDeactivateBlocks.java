...
/**
 * This event informs of the pending deactivation of a group of blocks. It is sent against the BlockTypeEntity for a
 * type of block, with the positions of thoe blocks being deactivated.
 */
