...
/**
 * A helper class for building and registering blocks with specific properties. Intended for use with Block Family
 * related code.
 * <p>
 * The core features of this helper is to convert from definition data, into a Block and to register this block into the
 * engine for use.
 */
public interface BlockBuilderHelper {
     ...
     * @see #constructSimpleBlock(BlockFamilyDefinition, BlockShape, String, BlockUri, BlockFamily)
     */
    Block constructSimpleBlock(BlockFamilyDefinition definition, BlockShape shape, BlockUri uri,
     ...
     * {@link #constructTransformedBlock(BlockFamilyDefinition,
     * Rotation, BlockUri, BlockFamily)} and {@link #constructCustomBlock(String, BlockShape, Rotation,
     * SectionDefinitionData, BlockUri, BlockFamily)}
     *
     ...
     */
    Block constructSimpleBlock(BlockFamilyDefinition definition, BlockShape shape, String section, BlockUri uri,
                               BlockFamily blockFamily);

    /**
     * @see #constructTransformedBlock(BlockFamilyDefinition, Rotation, BlockUri, BlockFamily)
     */
    Block constructTransformedBlock(BlockFamilyDefinition definition, Rotation rotation, BlockUri uri,
                                    BlockFamily blockFamily);

    /**
     * @see #constructTransformedBlock(BlockFamilyDefinition, Rotation, BlockUri, BlockFamily)
     */
    Block constructTransformedBlock(BlockFamilyDefinition definition, String section, Rotation rotation, BlockUri uri
            , BlockFamily blockFamily);
     ...
     * <p>
     * For blocks that do not have a rotation, see {@link #constructSimpleBlock(BlockFamilyDefinition, BlockShape,
     * String, BlockUri, BlockFamily)} For blocks that require more custom control/values see {@link
     * #constructCustomBlock(String, BlockShape, Rotation, SectionDefinitionData, BlockUri, BlockFamily)}
     *
     ...
     * @return
     */
    Block constructTransformedBlock(BlockFamilyDefinition definition, BlockShape shape, String section,
                                    Rotation rotation, BlockUri uri, BlockFamily blockFamily);

    /**
     * Construct a block as a member of a family with specified values and information. This method, and the other
     * helper methods in this class, should be used to create the component blocks of a block family.
     * <p>
     * In particular, this method relies upon the section parameter, as this is what determines a large quantity of the
     * block's properties.
     *
