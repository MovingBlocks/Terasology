...
public interface ZoneRegionFunction {
     ...
     * <p>
     * Care should be taken to make sure this method is fast enough, because it will be called once for every block that
     * is in the parent zone (or for every block in the world, for top-level zones).
     *
