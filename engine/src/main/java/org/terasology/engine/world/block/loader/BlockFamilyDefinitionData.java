...
public class BlockFamilyDefinitionData implements AssetData {
    ...
    private final Map<String, SectionDefinitionData> sections = Maps.newLinkedHashMap();
    ...
    /**
     * @param section
     * @return Retrieves the data for the given section. If the section is not defined, retrieves the base section
     *         instead
     */
