...
/**
 * BlockPlacementData represents data that is useful for determining the orientation of new block. The data is supposed
 * to be derived from the players state when placing the block. BlockPlacementData is immutable.
 */
public class BlockPlacementData {
    ...
    /**
     * The position on the block surface that the user aimed at when placing the block. A vector in the range (0..1,
     * 0..1)
     */
     ...
     *         is being placed on the ground
     * @param viewingDirection The players viewing direction
     * @param relativeAttachmentPosition The position on the block surface that the user aimed at when placing
     *         the block. A vector in the range (0..1, 0..1)
     */
    public BlockPlacementData(Vector3ic blockPosition, Side attachmentSide, Vector3fc viewingDirection,
                              Vector2fc relativeAttachmentPosition) {
