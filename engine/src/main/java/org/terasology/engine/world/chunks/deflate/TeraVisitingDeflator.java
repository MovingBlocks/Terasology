...
public abstract class TeraVisitingDeflator extends TeraDeflator {
    ...
    public abstract TeraArray deflateSparseArray16Bit(short[][] inflated, short[] deflated, short fill, int rowSize,
                                                      int sizeX, int sizeY, int sizeZ);

    public abstract TeraArray deflateSparseArray8Bit(byte[][] inflated, byte[] deflated, byte fill, int rowSize,
                                                     int sizeX, int sizeY, int sizeZ);

    public abstract TeraArray deflateSparseArray4Bit(byte[][] inflated, byte[] deflated, byte fill, int rowSize,
                                                     int sizeX, int sizeY, int sizeZ);
