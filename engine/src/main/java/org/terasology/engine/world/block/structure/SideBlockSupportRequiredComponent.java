...
/**
 * Component for block entities that wish to describe their structural dependency on other blocks. One can describe what
 * are its support sides. If a block describes multiple sides as "allowed", at least one of them is required to exist in
 * order for the block to be "structurally sound".
 * <p>
