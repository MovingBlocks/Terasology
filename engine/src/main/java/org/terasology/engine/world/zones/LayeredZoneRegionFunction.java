...
public class LayeredZoneRegionFunction implements ZoneRegionFunction {
    ...
    private final ConcurrentMap<Vector2i, LayerRange> layerRangeMap =
            new ConcurrentHashMap<>(ChunkConstants.SIZE_X * ChunkConstants.SIZE_Z * 100);
    private final LayerThickness layerThickness;
    private long seed;
    private Zone parent;
