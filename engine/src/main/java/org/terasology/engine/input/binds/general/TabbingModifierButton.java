...
/**
 * Modifies the behaviour of tabbing between widgets Currently this reverses the tab order
 */
@RegisterBindButton(id = "tabbingModifier", description = "${engine:menu#binding-tabbing-modifier}", category =
        "general")
