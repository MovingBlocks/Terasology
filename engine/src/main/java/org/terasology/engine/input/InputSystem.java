...
import org.terasology.nui.input.device.nulldevice.NullControllerDevice;
import org.terasology.nui.input.device.nulldevice.NullKeyboardDevice;
import org.terasology.nui.input.device.nulldevice.NullMouseDevice;
...
public class InputSystem extends BaseComponentSystem {
    ...
    private final Queue<KeyboardAction> simulatedKeys = Queues.newArrayDeque();
