...
import org.terasology.nui.input.UnknownInput;

import java.util.Locale;
import java.util.Map;

/**
 * Unchanging final model of a keyboard. Identifies and creates accessible
 * {@link org.terasology.nui.input.Keyboard.Key}'s
 * for all of the keys on the keyboard.
 */
public final class Keyboard {
    ...
    public enum Key implements Input {
        ...
        KANA(KeyId.KANA, "KEY_KANA", "Kana"), // Japanese Keyboard key (for switching between roman and japanese
        // characters?
        F19(KeyId.F19, "KEY_F19", "F19"),
        CONVERT(KeyId.CONVERT, "KEY_CONVERT", "Convert"), // Japanese Keyboard key (for converting Hiragana
        // characters to Kanji?)
        ...
        private static final Map<String, Input> lookupByName;
        private static final TIntObjectMap<Input> lookupById;
