...
public class TargetSystem {
    ...
    /**
     * Gets the position of the block that is currently targeted. If there is currently no target, this will return a
     * null reference (isTargetAvailable() would have returned false in this case).
     *
