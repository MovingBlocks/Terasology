...
public class BindableButtonImpl implements BindableButton {
    ...
    private final BindButtonEvent buttonEvent;
    private final Set<Input> activeInputs = Sets.newHashSet();

    private final List<BindButtonSubscriber> subscribers = Lists.newArrayList();
