...
public abstract class AbstractBindableAxis implements BindableAxis {
    ...
    private final BindAxisEvent event;
    private float value;

    private final List<BindAxisSubscriber> subscribers = Lists.newArrayList();
    ...
    public void update(EntityRef[] inputEntities, float delta, EntityRef target, Vector3i targetBlockPos,
