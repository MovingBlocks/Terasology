...
public class CameraTargetSystem extends BaseComponentSystem {
    ...
    public void initialise() {
        ...
        //set the target distance to as far as the player can see. Used to get the focal distance for effects such as
        // DOF.
    }
    ...
    /**
     * Returns the distance between the camera and the target object. One usage of this is to generate out-of-focus
     * effects: the target object remains sharp while further away objects (and potentially also nearer ones) are
     * rendered out-of-focus (blurred).
     *
