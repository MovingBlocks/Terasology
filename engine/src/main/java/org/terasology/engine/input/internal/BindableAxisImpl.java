...
/**
 * This implementation is linked to a positive BindableButton (that pushes the axis towards 1) and a negative
 * BindableButton (that pushes it towards -1).
 */
public class BindableAxisImpl extends AbstractBindableAxis {
    private final BindableButton positiveInput;
    private final BindableButton negativeInput;

    public BindableAxisImpl(String id, BindAxisEvent event, BindableButton positiveButton,
