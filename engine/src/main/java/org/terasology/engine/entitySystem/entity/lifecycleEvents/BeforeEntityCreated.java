...
public class BeforeEntityCreated implements Event {
    ...
    private final Set<Class<? extends Component>> componentsToRemove = Sets.newLinkedHashSet();
    private final Map<Class<? extends Component>, Component> componentsToAdd = Maps.newLinkedHashMap();
    ...
    private final class IteratorImpl implements Iterator<Component> {
        private final Iterator<Component> sourceIterator;
        private final Iterator<Component> addedIterator;
