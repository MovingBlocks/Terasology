...
public final class ChunkConstants {
    ...
    public static final Region3i CHUNK_REGION = Region3i.createFromMinAndSize(new Vector3i(), CHUNK_SIZE);

    public static final Vector3i LOCAL_REGION_EXTENTS = new Vector3i(1);
