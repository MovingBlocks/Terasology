 ...
 */
public abstract class BaseCelestialSystem extends BaseComponentSystem implements CelestialSystem, UpdateSubscriberSystem {

    private final WorldTime worldTime;

    private long lastUpdate;

    public BaseCelestialSystem() {
    ...
    protected void fireEvents() {
        ...
        if (delta > 0) {
            ...
            long dawn = getDawn(day);
            long midday = getMidday(day);
            long dusk = getDusk(day);
            long midnight = getMidnight(day);
