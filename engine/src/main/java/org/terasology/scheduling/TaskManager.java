...
public interface TaskManager {
   ...
   /** Creates and returns a Runnable that wraps the one given and sets thread priority and optionally thread name and
     ...
     *
     * @param runnable
     *    The wrapped task.  May not be null.
     * @param threadName
   ...
   /** Creates and returns a Runnable that wraps the Task given and sets thread priority, thread activity monitoring,
     ...
     *
     * @param task
     *    The wrapped task.  Its name is also used as the thread monitoring acitivity name.  May not be null.
     * @param threadName
     *    The name to give the thread while the task runs, or null to keep the thread's default name.
     * @param threadPriority
     *    The priority to assign the thread while the task runs.
   ...
   /** Creates and returns a Callable that wraps the Runnable given, returns the given value when done, and sets
     ...
     *    The wrapped task.  May not be null.
     * @param result
     *    The result value to return when done.  May be null.
     * @param threadName
     *    The name to give the thread while the task runs, or null to keep the thread's default name.
     * @param threadPriority
     *    The priority to assign the thread while the task runs.
   ...
   /** Sets the number of worker threads allocated to the (current or next allocated) thread pool.
     *
     * @param value
     *    The new number of worker threads.  Must be positive.
     **/
   void setPoolSize(int value);

   /** Shuts down worker threads and removes the thread pool.
     *
     * @param gracefulWaitInMs
     *    The time (in milliseconds) to wait for currently scheduled tasks to be completed and the worker threads to terminate.
     * @param extraWaitInMs
     *    The time (in milliseconds) to wait for threads to terminate after f
     **/
