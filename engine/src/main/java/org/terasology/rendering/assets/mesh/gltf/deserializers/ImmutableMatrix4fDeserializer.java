...
/**
 * Json deserializer for an ImmutableMatrix4f.
 */
public class ImmutableMatrix4fDeserializer implements JsonDeserializer<ImmutableMatrix4f> {
    @Override
    public ImmutableMatrix4f deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
