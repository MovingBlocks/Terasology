 ...
 */
package org.terasology.rendering.assets.mesh.gltf.model;
...
public class GLTFNode {
    ...
    private ImmutableMatrix4f matrix = Matrix4f.IDENTITY;
    private Integer mesh;
    private ImmutableQuat4f rotation = Quat4f.IDENTITY;
    private ImmutableVector3f scale = Vector3f.ONE;
    private ImmutableVector3f translation = Vector3f.ZERO;
     ...
     */
    public ImmutableQuat4f getRotation() {
        return rotation;
    }
     ...
     */
    public ImmutableVector3f getScale() {
        return scale;
    }
