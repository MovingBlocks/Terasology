...
import org.terasology.rendering.assets.mesh.gltf.model.GLTFAttributeType;
import org.terasology.rendering.assets.mesh.gltf.model.GLTFComponentType;
...
public enum AttributeSemantic {
    ...
    private final Function<MeshData, Object> targetBufferSupplier;

    AttributeSemantic(String name, GLTFAttributeType supportedAccessorType, GLTFComponentType supportedComponentType, Function<MeshData, Object> targetBufferSupplier) {
        this(name, new GLTFAttributeType[]{supportedAccessorType}, new GLTFComponentType[]{supportedComponentType}, targetBufferSupplier);
    }

    AttributeSemantic(String name, GLTFAttributeType[] supportedAccessorTypes, GLTFComponentType[] supportedComponentTypes, Function<MeshData, Object> targetBufferSupplier) {
        this.name = name;
