...
//            rotationArray[i] = rotation;
    ...
    private Vector3f[] positionFromFloat16ArrayData(float[] inverseBindMatrixArray) {
        ...
        for (int i = 0; i < inverseBindMatrixArray.length / 16; ++i) {
            int offset = i * 16;
            Matrix4f matrix4f = new Matrix4f(FloatBuffer.wrap(Arrays.copyOfRange(inverseBindMatrixArray, offset, offset + 16)));//new Matrix4f(Arrays.copyOfRange(inverseBindMatrixArray, offset, offset + 16));
