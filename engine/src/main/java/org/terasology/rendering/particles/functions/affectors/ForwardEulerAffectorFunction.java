 ...
 */
public final class ForwardEulerAffectorFunction extends AffectorFunction<ForwardEulerAffectorComponent> {
    public ForwardEulerAffectorFunction() {
        super(ForwardEulerAffectorComponent.class, DataMask.POSITION, DataMask.VELOCITY);
    }

    @Override
    public void update(final ForwardEulerAffectorComponent component,
