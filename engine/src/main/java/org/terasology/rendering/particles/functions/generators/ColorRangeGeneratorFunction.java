...
public final class ColorRangeGeneratorFunction extends GeneratorFunction<ColorRangeGeneratorComponent> {
    ...
    public void onEmission(final ColorRangeGeneratorComponent component,
        ...
        particleData.color.setX(random.nextFloat(component.minColorComponents.y(), component.maxColorComponents.y()));
        particleData.color.setX(random.nextFloat(component.minColorComponents.z(), component.maxColorComponents.z()));
        particleData.color.setX(random.nextFloat(component.minColorComponents.w(), component.maxColorComponents.w()));
    }
}
