...
public final class VelocityRangeGeneratorFunction extends GeneratorFunction<VelocityRangeGeneratorComponent> {
    public VelocityRangeGeneratorFunction() {
        super(VelocityRangeGeneratorComponent.class, DataMask.VELOCITY);
    }
    ...
    public void onEmission(final VelocityRangeGeneratorComponent component,
                           ...
                           final Random random) {
        particleData.velocity.setX(random.nextFloat(component.minCoords.x(), component.maxCoords.x()));
        particleData.velocity.setY(random.nextFloat(component.minCoords.y(), component.maxCoords.y()));
        particleData.velocity.setZ(random.nextFloat(component.minCoords.z(), component.maxCoords.z()));
    }
}
