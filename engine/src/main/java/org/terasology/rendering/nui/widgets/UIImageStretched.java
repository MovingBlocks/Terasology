 ...
 */
public class UIImageStretched extends CoreWidget {
    @LayoutConfig
    ...
    public UIImageStretched() {
    }

    public UIImageStretched(String id) {
        super(id);
    }

    public UIImageStretched(TextureRegion image) {
        this.image.set(image);
    }

    public UIImageStretched(String id, TextureRegion image) {
        super(id);
        this.image.set(image);
    }
