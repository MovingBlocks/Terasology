...
public class FlowParagraphData implements ParagraphData {
    ...
    private boolean insetOnLeft;

    public FlowParagraphData(ParagraphRenderStyle paragraphRenderStyle) {
        this.paragraphRenderStyle = paragraphRenderStyle;
    }

    public FlowParagraphData(ParagraphRenderStyle paragraphRenderStyle, DocumentData insetDocument, int insetWidth, boolean insetOnLeft) {
        this.paragraphRenderStyle = paragraphRenderStyle;
        this.insetDocument = insetDocument;
        this.insetWidth = insetWidth;
        this.insetOnLeft = insetOnLeft;
    }
    ...
    public ParagraphRenderable getParagraphContents() {
        return new FlowParagraphRenderable(insetDocument, insetOnLeft, insetWidth, Collections.unmodifiableList(data));
    }
