...
public class DebugOverlay extends CoreScreenLayer {
    ...
    private List<MetricsMode> metricsModes = Lists.newArrayList(new NullMetricsMode(), new RunningMeansMode(), new SpikesMode(), new RunningThreadsMode(), new WorldRendererMode());
