 ...
 */
    ...
    public void initialise() {
        ...
        WidgetUtil.tryBindCheckbox(this, "fullscreen", BindHelper.bindBeanProperty("fullscreen", config.getRendering(), Boolean.TYPE));
        ...
        //region WIP Feature
        /*
        WidgetUtil.trySubscribe(this, "advancedVideo", new ActivateEventListener() {
            @Override
            public void onActivated(UIWidget button) {
                getManager().pushScreen("engine:advancedVideoMenuScreen");
            }
        });
        */
        //endregion
