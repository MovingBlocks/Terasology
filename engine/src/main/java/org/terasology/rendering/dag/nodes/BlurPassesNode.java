...
public class BlurPassesNode extends ConditionDependentNode {
    ...
    public void initialise() {
        ...
        addDesiredStateChange(new EnableMaterial(BLUR_MATERIAL.toString()));
        blur = getMaterial(BLUR_MATERIAL);
    }
    ...
    public void process() {
        ...
        sceneToneMapped = displayResolutionDependentFBOs.get(TONE_MAPPED_FBO);
