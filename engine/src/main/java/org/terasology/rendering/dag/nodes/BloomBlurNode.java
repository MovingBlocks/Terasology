...
public class BloomBlurNode extends BlurNode {
     ...
     */
    public BloomBlurNode(Context context, FBOConfig inputConfig, FBOConfig outputConfig, String performanceMonitorLabel) {
        super(context, inputConfig, outputConfig, context.get(DisplayResolutionDependentFBOs.class), BLUR_RADIUS, performanceMonitorLabel);
    }
