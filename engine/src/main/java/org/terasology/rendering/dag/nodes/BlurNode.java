...
public class BlurNode extends ConditionDependentNode implements FBOManagerSubscriber {
     ...
     */
    public BlurNode(Context context, FBOConfig inputFboConfig, FBOConfig outputFboConfig, BaseFBOsManager fboManager, float blurRadius, String performanceMonitorLabel) {
        this.fboManager = fboManager;
        this.blurRadius = blurRadius;
        this.performanceMonitorLabel = performanceMonitorLabel;
