...
public class LateBlurNode extends BlurNode {
     ...
     */
    public LateBlurNode(Context context, FBOConfig inputFboConfig, FBOConfig outputFboConfig, String aLabel) {
        super(context, inputFboConfig, outputFboConfig, context.get(DisplayResolutionDependentFBOs.class), 0, aLabel); // note: blurRadius is 0.0 at this stage.
