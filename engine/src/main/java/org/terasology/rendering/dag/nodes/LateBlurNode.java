...
public class LateBlurNode extends BlurNode {
     ...
     * @param performanceMonitorLabel a String to label the instance's entry in output generated by the PerformanceMonitor
     */
    public LateBlurNode(Context context, FBOConfig inputFboConfig, FBOConfig outputFboConfig, String performanceMonitorLabel) {
        super(context, inputFboConfig, outputFboConfig, context.get(DisplayResolutionDependentFBOs.class), 0, performanceMonitorLabel); // note: blurRadius is 0.0 at this stage.
