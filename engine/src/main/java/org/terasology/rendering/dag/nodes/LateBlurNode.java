...
public class LateBlurNode extends BlurNode {
     ...
     */
    public void initialise(FBOConfig inputFboConfig, FBOConfig outputFboConfig, String aLabel) {
        super.initialise(inputFboConfig, outputFboConfig, displayResolutionDependentFBOs, blurRadius, aLabel); // note: blurRadius is 0.0 at this stage.
