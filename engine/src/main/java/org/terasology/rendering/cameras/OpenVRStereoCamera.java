...
public class OpenVRStereoCamera extends SubmersibleCamera {
    ...
    private void jomlMatrix4f(org.joml.Matrix4f matrixInput, org.joml.Matrix4f matrixOut) {
...
//        matrixOut.set(3, 3, matrixInput.m33());
    ...
    public void updateMatrices(float fov) {
        ...
        viewMatrixReflectedLeftEye.set(viewMatrixReflected).mul(viewTranslationLeftEye);
        viewMatrixReflectedRightEye.set(viewMatrixReflected).mul(viewTranslationRightEye);
