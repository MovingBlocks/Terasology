...
public class LongSetting extends SettingImpl<Long> {
    public LongSetting(SimpleUri id, Long defaultValue) {
        super(id, defaultValue);
    }

    public LongSetting(SimpleUri id, Long defaultValue, SettingValueValidator<Long> validator) {
