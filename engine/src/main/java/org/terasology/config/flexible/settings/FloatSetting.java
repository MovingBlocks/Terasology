...
public class FloatSetting extends SettingImpl<Float> {
    public FloatSetting(SimpleUri id, Float defaultValue) {
        super(id, defaultValue);
    }

    public FloatSetting(SimpleUri id, Float defaultValue, SettingValueValidator<Float> validator) {
