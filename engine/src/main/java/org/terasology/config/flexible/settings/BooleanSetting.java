...
public class BooleanSetting extends SettingImpl<Boolean> {
    public BooleanSetting(SimpleUri id, Boolean defaultValue) {
        super(id, defaultValue);
    }

    public BooleanSetting(SimpleUri id, Boolean defaultValue, SettingValueValidator<Boolean> validator) {
