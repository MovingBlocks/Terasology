...
public class ProtobufSerializationContext implements SerializationContext {
    ...
    public PersistedData createStrings(Iterable<String> value) {
        return new ProtobufPersistedData(EntityData.Value.newBuilder().addAllString(value));
    }

    @Override
    public PersistedData create(float value) {
        return new ProtobufPersistedData(EntityData.Value.newBuilder().addFloat(value));
    }
    ...
    public PersistedData create(float... values) {
        ...
        return new ProtobufPersistedData(builder);
    }
    ...
    public PersistedData create(int value) {
        return new ProtobufPersistedData(EntityData.Value.newBuilder().addInteger(value));
    }
    ...
    public PersistedData create(long value) {
        return new ProtobufPersistedData(EntityData.Value.newBuilder().addLong(value));
    }
    ...
    public PersistedData create(boolean value) {
        return new ProtobufPersistedData(EntityData.Value.newBuilder().addBoolean(value));
    }
    ...
    public PersistedData create(double value) {
        return new ProtobufPersistedData(EntityData.Value.newBuilder().addDouble(value));
    }
    ...
    public PersistedData create(byte[] value) {
        return new ProtobufPersistedData(EntityData.Value.newBuilder().setBytes(ByteString.copyFrom(value)));
    }
    ...
    public PersistedData create(Iterable<PersistedData> data) {
        ...
        for (PersistedData value : data) {
            builder.addValue((EntityData.Value.Builder) ((ProtobufPersistedData) value).getValue());
        }
        return new ProtobufPersistedData(builder);
    }
    ...
    public PersistedData create(Map<String, PersistedData> data) {
        ...
        for (Map.Entry<String, PersistedData> entry : data.entrySet()) {
            builder.addNameValue(EntityData.NameValue.newBuilder()
                    ...
                    .setValue((EntityData.Value.Builder) ((ProtobufPersistedData) entry.getValue()).getValue()).build());
        }
        return new ProtobufPersistedData(builder);
    }
    ...
    @Override
    public <T> PersistedData create(Iterable<T> data, Class<T> type) {
        return null;
    }

    @Override
    public PersistedData createNull() {
        return new ProtobufPersistedData(EntityData.Value.newBuilder());
    }
}
