 ...
 */
public class UnregisterBlockSelectionForRenderingEvent extends AbstractConsumableEvent {

    private BlockSelectionComponent blockSelectionComponent;

    public UnregisterBlockSelectionForRenderingEvent(BlockSelectionComponent blockSelectionComponent) {
