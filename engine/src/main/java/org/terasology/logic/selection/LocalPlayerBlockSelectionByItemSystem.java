...
public class LocalPlayerBlockSelectionByItemSystem extends BaseComponentSystem {
     ...
     * @param entityRef The entity sending the event. This entity must have the {@link BlockSelectionComponent}
     */
    @ReceiveEvent(components = {BlockSelectionComponent.class})
    public void onMovableBlockSelectionStart(MovableSelectionStartEvent event, EntityRef entityRef) {
        this.blockSelectionComponentEntity = entityRef;
    }
