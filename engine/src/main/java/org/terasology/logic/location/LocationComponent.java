...
public final class LocationComponent implements Component, ReplicationCheck {
    ...
    @Replicate
    Quaternionf lastRotation = new Quaternionf(0,0,0,1);
    ...
    public Vector3f getLocalDirection() {
        Vector3f result = JomlUtil.from(Direction.FORWARD.getVector3f());
...
//        getLocalRotation().rotate(result, result);
    ...
    public Vector3f getWorldPosition(Vector3f output) {
        ...
        while (parentLoc != null) {
            ...
            output.rotate(parentLoc.getLocalRotation());
//            parentLoc.getLocalRotation().transform(output, output);
    ...
    public Quaternionf getWorldRotation() {
        return getWorldRotation(new Quaternionf(0, 0, 0, 1));
    }
...
//            parentLoc.getLocalRotation().conjugate(rot);
//            rot.inverse(parentLoc.getWorldRotation());
//            rot.transform(this.position, this.position);
