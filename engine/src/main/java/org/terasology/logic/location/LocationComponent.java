...
public final class LocationComponent implements Component, ReplicationCheck {
    ...
    public void setWorldPosition(Vector3f value) {
        ...
        if (parentLoc != null) {
            ...
            Quaternionf inverseWorldRotation = parentLoc.getWorldRotation().conjugate();
            this.position.rotate(inverseWorldRotation);
        }
    }
    ...
    public void setWorldRotation(Quaternionf value) {
        ...
        if (parentLoc != null) {
            Quaternionf inverseWorldRotation = parentLoc.getWorldRotation().conjugate();
            inverseWorldRotation.mul(rotation, rotation);
        }
    }
