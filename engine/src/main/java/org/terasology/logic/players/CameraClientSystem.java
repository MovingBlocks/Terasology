...
public class CameraClientSystem extends BaseComponentSystem {
    ...
    private void mountCamera() {
        ...
        if (cameraLocation != null) {
            Location.attachChild(targetEntityForCamera, clientComponent.camera, cameraLocation.getLocalPosition(), new Quaternionf().identity());
        } else {
            Location.attachChild(targetEntityForCamera, clientComponent.camera, new Vector3f(), new Quaternionf().identity());
        }
    }
}
