 ...
 * Parameters should be annotated by the {@link CommandParameter} annotation.
 * <p/>
 ...
 * to change the delimiter, provide the {@code arrayDelimiter} argument to the linked {@link CommandParameter}.
 * Array delimiters can be escaped using the {@code Command.ARRAY_DELIMITER_ESCAPE_CHARACTER}.
 * To make a command accept a variable amount of arguments (varargs), set the {@link CommandParameter}'s
