...
public class ReloadSkinCommand extends Command {
    public ReloadSkinCommand() {
        super("reloadSkin", false, "Reloads a skin", null);
    }

    @Override
    protected CommandParameter[] constructParameters() {
        return new CommandParameter[] {
                CommandParameter.single("skin", String.class, true)
        };
    }

    public String execute(EntityRef sender, String skin)
    {
