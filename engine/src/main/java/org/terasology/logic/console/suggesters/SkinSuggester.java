...
/**
 * Suggest skin names. When only one skin resource exists for the entire set of loaded modules,
 * the name alone suffices. Otherwise, the module name must be prepended.
 * <p>
 * TODO: if possible, merge with ScreenSuggester into a universal solution for all assets of a given type
 */
public class SkinSuggester implements CommandParameterSuggester<String> {
    ...
    public Set<String> suggest(EntityRef sender, Object... resolvedParameters) {
        ...
        for (ResourceUrn resolvedParameter : assetManager.getAvailableAssets(UISkin.class)) {
