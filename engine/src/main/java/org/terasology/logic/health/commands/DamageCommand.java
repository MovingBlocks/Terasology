...
public class DamageCommand extends Command {
    public DamageCommand() {
        super("damage", true, "Reduce the player's health by an amount", null);
    }

    @Override
    protected CommandParameter[] constructParameters() {
        return new CommandParameter[] {
                CommandParameter.single("amount", Integer.class, true)
        };
    }

    public String execute(EntityRef sender, Integer amount) {
