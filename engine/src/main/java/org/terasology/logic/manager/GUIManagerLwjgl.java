...
import org.terasology.rendering.gui.framework.UIDisplayRendererLwjgl;
...
public class GUIManagerLwjgl implements ComponentSystem, GUIManager {
    ...
    public GUIManagerLwjgl(GameEngine engine) {
        this.engine = engine;
        renderer = new UIDisplayRendererLwjgl();
