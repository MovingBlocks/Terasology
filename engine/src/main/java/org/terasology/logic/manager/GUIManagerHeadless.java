...
import org.terasology.rendering.gui.framework.UIDisplayRendererHeadless;
...
public class GUIManagerHeadless implements ComponentSystem {
    ...
    public GUIManagerHeadless(GameEngine engine) {
        this.engine = engine;
        renderer = new UIDisplayRendererHeadless();
