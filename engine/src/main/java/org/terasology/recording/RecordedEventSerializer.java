...
class RecordedEventSerializer {
    ...
    private TypeHandler recordedEventListTypeHandler;
    ...
    public RecordedEventSerializer(EntityManager entityManager, ModuleEnvironment moduleEnvironment) {
        ...
        this.recordedEventListTypeHandler = typeSerializationLibrary.getTypeHandler(new TypeInfo<List<RecordedEvent>>() { });
    }
