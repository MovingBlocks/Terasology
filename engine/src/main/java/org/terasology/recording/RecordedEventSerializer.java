...
class RecordedEventSerializer {
    ...
    private void writeSpecificEventData(JsonWriter writer, Event event) {
        try {
            ...
            if (event instanceof InputEvent) {
                ...
                TypeHandler handler = typeSerializationLibrary.getHandlerFor(StaticSound.class);
                ...
                TypeHandler handler = typeSerializationLibrary.getHandlerFor(Vector3f.class);
                ...
                TypeHandler handler = typeSerializationLibrary.getHandlerFor(MovementMode.class);
    ...
    private void writeRealVector3fData(JsonWriter writer, GsonSerializationContext serializationContext, InputEvent e) throws IOException {
        ...
        handler = typeSerializationLibrary.getHandlerFor(Vector3i.class);
    ...
    private void writeInputEventInstanceData(JsonWriter writer, Event event, GsonSerializationContext serializationContext) throws Exception {
        if (event instanceof MouseWheelEvent) {
            ...
            TypeHandler handler = typeSerializationLibrary.getHandlerFor(Vector2i.class);
            ...
            TypeHandler handler = typeSerializationLibrary.getHandlerFor(MouseAxisEvent.MouseAxis.class);
            ...
            TypeHandler handler = typeSerializationLibrary.getHandlerFor(ButtonState.class);
            ...
            writer.name("id");
            writer.beginObject();
            handler = typeSerializationLibrary.getHandlerFor(Name.class);
            ...
            GsonPersistedData data = (GsonPersistedData) handler.serialize(e.getState(), serializationContext);
            writer.name("state").value(data.getAsString());
            handler = typeSerializationLibrary.getHandlerFor(Keyboard.Key.class); // might need to add some things to key
            ...
            GsonPersistedData data = (GsonPersistedData) handler.serialize(e.getState(), serializationContext);
            writer.name("state").value(data.getAsString());
            handler = typeSerializationLibrary.getHandlerFor(MouseInput.class);
            data = (GsonPersistedData) handler.serialize(e.getButton(), serializationContext);
            writer.name("button").value(data.getAsString());
            handler = typeSerializationLibrary.getHandlerFor(Vector2i.class);
    ...
    private InputEvent getInputEventSpecificType(JsonObject jsonObject, String className, GsonDeserializationContext deserializationContext) {
        ...
        try {
            ...
            if (BindButtonEvent.class.isAssignableFrom(clazz) || BindAxisEvent.class.isAssignableFrom(clazz)) {
                ...
                TypeHandler typeHandler = typeSerializationLibrary.getHandlerFor(Keyboard.Key.class);
                ...
                typeHandler = typeSerializationLibrary.getHandlerFor(ButtonState.class);
                ...
                TypeHandler typeHandler = typeSerializationLibrary.getHandlerFor(MouseInput.class);
                ...
                TypeHandler typeHandler = typeSerializationLibrary.getHandlerFor(MouseAxisEvent.MouseAxis.class);
    ...
    private void bindButtonEventSetup(BindButtonEvent event, JsonObject jsonObject, GsonDeserializationContext deserializationContext) {
        ...
        TypeHandler typeHandler = typeSerializationLibrary.getHandlerFor(ButtonState.class);
        ButtonState state = (ButtonState) typeHandler.deserialize(data, deserializationContext);
        float delta = jsonObject.get("delta").getAsFloat();
        typeHandler = typeSerializationLibrary.getHandlerFor(Name.class);
