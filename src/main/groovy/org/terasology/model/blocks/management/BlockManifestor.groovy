...
class BlockManifestor {
    ...
    public loadConfig() throws Exception {
        ...
        if (worldExists) {
            ...
            org.terasology.model.blocks.management.BlockManifestor.log.info "The image index (ImageManifest not yet saved) now looks like this: " + _imageIndex
        }
    ...
    public saveManifest() {
        ...
        org.terasology.model.blocks.management.BlockManifestor.log.info "Saving merged Block texture file to " + _imageManifest.absolutePath
        ...
        org.terasology.model.blocks.management.BlockManifestor.log.info "Saving block IDs and image atlas (index) positions to " + _blockManifest.absolutePath
        _blockManifest.withWriter { writer ->
            writer << '// Warning: Editing this file may do crazy things to your saved world!\r\n'
            manifest.writeTo(writer)
        }
        org.terasology.model.blocks.management.BlockManifestor.log.info "The block index now looks like this: " + _blockIndex
    }
    ...
    private loadManifest() {
        ...
        org.terasology.model.blocks.management.BlockManifestor.log.info "LOADED imageIndex from " + _imageManifest.getAbsolutePath() + " is: " + _imageIndex
        org.terasology.model.blocks.management.BlockManifestor.log.info "LOADED blockIndex from " + _blockManifest.getAbsolutePath() + " is: " + _blockStringIndex
        org.terasology.model.blocks.management.BlockManifestor.log.info "LOADED nextByte: " + _nextByte
    }
    ...
    private int getImageId(String name) {
        ...
        org.terasology.model.blocks.management.BlockManifestor.log.severe "Unknown texture: " + name;
        return 0;
    }
