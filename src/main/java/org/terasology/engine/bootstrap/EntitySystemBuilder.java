...
public class EntitySystemBuilder {
    ...
    public EngineEntityManager build(ModuleManager moduleManager, NetworkSystem networkSystem, ReflectFactory reflectFactory) {
        ...
        EntitySystemLibrary library = CoreRegistry.put(EntitySystemLibrary.class, new EntitySystemLibraryImpl(reflectFactory, copyStrategyLibrary, typeSerializationLibrary));
