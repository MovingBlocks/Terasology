...
public interface MouseButtonListener {
     ...
     */
    void up(UIDisplayElement element, int button, boolean intersect);
     ...
     * @param intersect True if the current mouse position intersects with the element.
     */
    void down(UIDisplayElement element, int button, boolean intersect);
     ...
     * @param intersect True if the current mouse position intersects with the element.
     */
    void wheel(UIDisplayElement element, int wheel, boolean intersect);
