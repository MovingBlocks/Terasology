 ...
 * @author Immortius
 */
public class PerlinTerrainGenerator implements NewChunkGenerator {
    ...
    private void GenerateOuterLayer(int x, int y, int z, int firstBlockHeight, NewChunk c, WorldBiomeProvider.Biome type) {
    ...
    private double calcDensity(int x, int y, int z) {
