 ...
 * <p/>
 * It has a (unique) label - typically the symbol you use in the grammar. There is no further information a {@code ShapeSymbol} holds except
 * for the geometric information of a Shape itself.
 *
