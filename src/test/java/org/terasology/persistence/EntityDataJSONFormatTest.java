...
public class EntityDataJSONFormatTest {
    ...
    private EntityData.GlobalEntityStore.Builder worldBuilder;
    ...
    @Before
    public void setup() {
        worldBuilder = EntityData.GlobalEntityStore.newBuilder();
    ...
    @Test
     public void testPersistComponentWithDouble() throws Exception {
        ...
        entityBuilder.addComponent(componentBuilder.build());
        worldBuilder.addEntity(entityBuilder.build());
        EntityData.GlobalEntityStore actual = persistAndRetrieve(worldBuilder.build());
    ...
    private void assertPersist(EntityData.GlobalEntityStore.Builder worldBuilder) throws IOException{
        EntityData.GlobalEntityStore world = worldBuilder.build();
        EntityData.GlobalEntityStore newWorld = persistAndRetrieve(world);
        assertEquals(world, newWorld);
    }

    private EntityData.GlobalEntityStore persistAndRetrieve(EntityData.GlobalEntityStore world) throws IOException {
