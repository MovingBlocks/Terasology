...
public class ShaderProgram {
    ...
    static {
        _preProcessorPreamble += ((Boolean) ConfigurationManager.getInstance().getGameSetting("Game.Graphics.animatedWaterAndGrass")) ? "#define ANIMATED_WATER_AND_GRASS \n" : "";
        _preProcessorPreamble += "#define GAMMA " + ConfigurationManager.getInstance().getGameSetting("Game.Graphics.gamma").toString() + "\n";
    }
