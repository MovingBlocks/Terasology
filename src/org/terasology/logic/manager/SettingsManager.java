...
public final class SettingsManager {
    ...
    private static final String DEFAULT_WORLD_SETTINGS = "WorldSettings.wrl";
    private static final String DEFAULT_USER_SETTINGS = "UserSettings.usr";
    private static final String WORLD_SETTINGS = "DefaultWorldSettings.wrl";
    private static final String USER_SETTINGS = "DefaultUserSettings.usr";
    ...
    private void trySetWorldSetting() {
        if(!setUserSettingInternal(WORLD_SETTINGS)){
            if(!setUserSettingInternal(DEFAULT_WORLD_SETTINGS)){
    ...
    private void trySetUserSetting() {
        if(!setWorldSettingInternal(USER_SETTINGS)){
            if(!setWorldSettingInternal(DEFAULT_USER_SETTINGS)){
