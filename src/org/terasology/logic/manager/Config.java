...
public final class Config {
    ...
    private double _maxGravity = 1.0d;
    private double _maxGravitySwimming = 0.04d;
    private double _gravity = 0.008d;
    private double _gravitySwimming = 0.008d * 4d;
    private double _friction = 0.15d;
    private double _walkingSpeed = 0.025d;
    private double _runningFactor = 1.5d;
    private double _jumpIntensity = 0.16d;
    ...
    public void setMaxGravity(double _maxGravity) {
        this._maxGravity = _maxGravity;
    }

    public double getMaxGravitySwimming() {
        return _maxGravitySwimming;
    }

    public void setMaxGravitySwimming(double _maxGravitySwimming) {
        this._maxGravitySwimming = _maxGravitySwimming;
    }
    ...
    public double getGravitySwimming() {
        return _gravitySwimming;
    }

    public void setGravitySwimming(double _gravitySwimming) {
        this._gravitySwimming = _gravitySwimming;
    }
    ...
    public void setWalkingSpeed(double _walkingSpeed) {
        this._walkingSpeed = _walkingSpeed;
    }

    public double getRunningFactor() {
        return _runningFactor;
    }

    public void setRunningFactor(double _runningFactor) {
        this._runningFactor = _runningFactor;
    }

    public double getJumpIntensity() {
        return _jumpIntensity;
    }

    public void setJumpIntensity(double _jumpIntensity) {
        this._jumpIntensity = _jumpIntensity;
    }
