...
public abstract class MovableEntity extends Entity {
    ...
    public void render() {
        ...
        if ((Boolean) ConfigurationManager.getInstance().getServerSetting("World.Debug.debugCollision")) {
            getAABB().render(2f);
    ...
    protected void updatePosition() {
        ...
        double friction = (Double) ConfigurationManager.getInstance().getServerSetting("World.Physics.friction");
        ...
        double maxGravity = (Double) ConfigurationManager.getInstance().getServerSetting("World.Physics.maxGravity");
        double maxGravitySwimming = (Double) ConfigurationManager.getInstance().getServerSetting("World.Physics.maxGravitySwimming");
        double gravitySwimming = (Double) ConfigurationManager.getInstance().getServerSetting("World.Physics.gravitySwimming");
        double gravity = (Double) ConfigurationManager.getInstance().getServerSetting("World.Physics.gravity");
