...
void main()
{
    ...
    grassCoordinates[0] =   vec4(0.0625 * 12, 0.0625 * 13, 0.0625 * 11, 0.0625 * 12);
    grassCoordinates[1] =   vec4(0.0625 * 13, 0.0625 * 14, 0.0625 * 0, 0.0625 * 1);
    grassCoordinates[2] =   vec4(0.0625 * 12, 0.0625 * 13, 0.0625 * 0, 0.0625 * 1);
    grassCoordinates[3] =   vec4(0.0625 * 13, 0.0625 * 14, 0.0625 * 11, 0.0625 * 12);
    grassCoordinates[4] =   vec4(0.0625 * 14, 0.0625 * 15, 0.0625 * 11, 0.0625 * 12);
