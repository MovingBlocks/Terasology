 ...
 */
@RegisterSystem
public class CraftingSystem implements UpdateSubscriberSystem, RenderSystem {
    ...
    private void initCraftUI() {
        ...
        inventory.setEntity(CoreRegistry.get(LocalPlayer.class).getCharacterEntity(), 0);
