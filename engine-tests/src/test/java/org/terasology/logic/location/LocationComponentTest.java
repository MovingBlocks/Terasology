...
public class LocationComponentTest extends TerasologyTestingEnvironment {
    ...
    EntityRef entity;
    org.joml.Vector3f pos1 = new org.joml.Vector3f(1, 2, 3);
    org.joml.Vector3f pos2 = new org.joml.Vector3f(2, 3, 4);
    org.joml.Vector3f pos1plus2 = new org.joml.Vector3f(3, 5, 7);
    ...
    public void testUnparentedWorldLocationSameAsLocal() {
        loc.setLocalPosition(pos1);
        assertEquals(JomlUtil.from(loc.getLocalPosition()), loc.getWorldPosition(new org.joml.Vector3f()));
    }
    ...
    public void testOffsetParentAddsToWorldLocation() {
        ...
        assertEquals(pos1plus2, loc.getWorldPosition(new org.joml.Vector3f()));
    }
    ...
    public void testScaleRotateAndOffsetCombineCorrectlyForWorldPosition() {
        ...
        TeraAssert.assertEquals(new org.joml.Vector3f(8, 7, 2), loc.getWorldPosition(new org.joml.Vector3f()), 0.00001f);
    }
    ...
    public void testSetWorldPositionWorksWithNoParent() {
        ...
        TeraAssert.assertEquals(pos1, loc.getWorldPosition(new org.joml.Vector3f()), 0.0001f);
    }
    ...
    public void testSetWorldPositionWorksWithRotatedParent() {
        ...
        parent.setLocalRotation(yawRotation);
        loc.setWorldPosition(pos1);
        TeraAssert.assertEquals(pos1, loc.getWorldPosition(new org.joml.Vector3f()), 0.000001f);
    }
    ...
    public void testSetWorldPositionWorksWithNestedRotatedParent() {
        ...
        second.setLocalPosition(new org.joml.Vector3f(1, 0, 0));
        first.setLocalRotation(yawRotation);
        TeraAssert.assertEquals(new org.joml.Vector3f(0, 0, -1), second.getWorldPosition(new org.joml.Vector3f()), 0.000001f);
        Location.attachChild(secondEntity, thirdEntity);
        second.setLocalRotation(pitchRotation);
        third.setLocalPosition(new org.joml.Vector3f(0, 0, 0));
        TeraAssert.assertEquals(new org.joml.Vector3f(0, 0, -1), third.getWorldPosition(new org.joml.Vector3f()), 0.000001f);
        third.setLocalPosition(new org.joml.Vector3f(0, 0, 1));
        TeraAssert.assertEquals(new org.joml.Vector3f(0.5f * (float) Math.sqrt(2), -0.5f * (float) Math.sqrt(2), -1), third.getWorldPosition(new org.joml.Vector3f()), 0.000001f);
    ...
    public void testPositionMaintainedWhenAttachedToParent() {
        ...
        parent.setWorldPosition(new org.joml.Vector3f(1, 0, 0));

        loc.setWorldPosition(new org.joml.Vector3f(2, 0, 0));
        Location.attachChild(parentEntity, entity);

        TeraAssert.assertEquals(new org.joml.Vector3f(2, 0, 0), loc.getWorldPosition(new org.joml.Vector3f()), 0.000001f);
    }
