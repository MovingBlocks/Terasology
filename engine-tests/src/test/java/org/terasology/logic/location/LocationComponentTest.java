...
public class LocationComponentTest extends TerasologyTestingEnvironment {
    ...
    public void setup() {
        ...
        yawRotation = new Quaternionf(TeraMath.DEG_TO_RAD * 90, 0, 0);
        pitchRotation = new Quaternionf(0, TeraMath.DEG_TO_RAD * 45, 0);
        yawPitch = new Quaternionf(TeraMath.DEG_TO_RAD * 90, TeraMath.DEG_TO_RAD * 45, 0);
    }
