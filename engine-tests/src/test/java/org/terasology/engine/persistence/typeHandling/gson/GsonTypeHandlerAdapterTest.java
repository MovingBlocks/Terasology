...
public class GsonTypeHandlerAdapterTest {
    ...
    /**
     * {@link GsonTypeHandlerAdapter#read(JsonReader)} is tested by deserializing an object from JSON via Gson with a
     * registered {@link GsonTypeHandlerAdapterFactory} which creates instances of {@link GsonTypeHandlerAdapter}.
     */
    @Test
    ...
    /**
     * {@link GsonTypeHandlerAdapter#write(JsonWriter, Object)} is tested by serializing an object to JSON via Gson with
     * a registered {@link GsonTypeHandlerAdapterFactory} which creates instances of {@link GsonTypeHandlerAdapter}.
     */
    @Test
