...
public class TypeSerializerTest extends ModuleEnvironmentTest {
    ...
    private static final String INSTANCE_JSON = "{\"generic-t\":-559038737,\"list\":[50,51,-52,-53]," +
            "\"animals\":[{\"class\":\"org.terasology.persistence.serializers.TypeSerializerTest$Dog\"," +
            "\"tailPosition\":[3.15,54.51,-0.001],\"headPosition\":[10.0,30.0,-0.001],\"data\":{\"class\":\"java.lang" +
            ".Integer\",\"content\":1}},{\"class\":\"org.terasology.persistence.serializers" +
    ...
    static {
        ...
        INSTANCE.animals.add(new Dog<>(1, new Vector3f(3.15f, 54.51f, -0.001f), new org.joml.Vector3f(10.0f, 30.0f,
                -0.001f)));
