...
public class BetweenChunkPropagationTest extends TerasologyTestingEnvironment {
    ...
    private final SelectChunkProvider provider = new SelectChunkProvider();
    ...
    public void testBetweenChunksSimple() {
        ...
        for (Vector3i pos : ChunkConstants.CHUNK_REGION) {
            assertEquals(ChunkConstants.MAX_SUNLIGHT, bottomChunk.getSunlight(pos),
                    () -> "Incorrect at position " + pos);
            assertEquals(ChunkConstants.MAX_SUNLIGHT_REGEN, bottomChunk.getSunlightRegen(pos), () -> "Incorrect at " +
                    "position " + pos);
        }
    }
    ...
    public void testPropagateSunlightAppearingMidChunk() {
        ...
        for (Vector3i pos : Region3i.createFromMinAndSize(new Vector3i(8, 0, 8),
                new Vector3i(ChunkConstants.SIZE_X - 16, 1, ChunkConstants.SIZE_Z - 16))) {
            topChunk.setSunlight(pos, (byte) 0);
