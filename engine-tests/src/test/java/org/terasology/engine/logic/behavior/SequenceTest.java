...
public class SequenceTest extends CountCallsTest {
    ...
    public void testAllSuccess() {
        assertBT("{ sequence:[success, success, success]}",
                Arrays.asList(BehaviorState.SUCCESS, BehaviorState.SUCCESS, BehaviorState.SUCCESS), Arrays.asList(4,
                        1, 2, 3, 4, 4));
    ...
    public void testAllFail() {
        assertBT("{ sequence:[failure, failure, failure]}",
                Arrays.asList(BehaviorState.FAILURE, BehaviorState.FAILURE, BehaviorState.FAILURE), Arrays.asList(4,
                        1, 4, 1, 4, 1));
    }
    ...
    public void testAllRunning() {
        assertBT("{ sequence:[running, running, running]}",
                Arrays.asList(BehaviorState.RUNNING, BehaviorState.RUNNING, BehaviorState.RUNNING), Arrays.asList(4,
                        1, 4, 1, 4, 1));
    }
