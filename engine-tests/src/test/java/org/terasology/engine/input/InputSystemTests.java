...
public class InputSystemTests {
    ...
    private void setUpLocalPlayer(Context context) {
        ...
        localPlayer.setRecordAndReplayClasses(new DirectionAndOriginPosRecorderList(),
                new RecordAndReplayCurrentStatus());
    ...
    public void testKeyBinding() {
        ...
        keyBinds.put(KeyId.T, new BindableButtonImpl(new SimpleUri("engine-tests", "testEvent"), "theTestEvent",
                new TestEventButton()));
    ...
    private static class TestKeyboard implements KeyboardDevice {
        ...
        private final Queue<KeyboardAction> queue = new LinkedBlockingQueue<>();
