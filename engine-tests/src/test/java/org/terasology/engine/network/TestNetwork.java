...
public class TestNetwork extends TerasologyTestingEnvironment {
    ...
    private final List<NetworkSystem> netSystems = Lists.newArrayList();
    ...
    public void setup() throws Exception {
        ...
        context.get(Config.class).getSecurity().setServerCredentials(serverIdentiy.getPublicCert(),
                serverIdentiy.getPrivateCert());
    }
