 ...
 * TODO fix - esp. get rid of CoreRegistry
 */
public class WorldProvidingHeadlessEnvironment extends HeadlessEnvironment {
    ...
    public void setupWorldProvider(WorldGenerator generator) {
        ...
        WorldProviderCore stub = new MapWorldProvider(
                generator,
                context.get(BlockManagerImpl.class),
                context.get(BiomeManager.class));
    ...
    // TODO figure this out properly with gestalt
//
...
//        blockManager.getBlockF(new SymmetricFamily(block.getURI(), block), true);
//
//        nextBlockId++;
//
//        return block;
