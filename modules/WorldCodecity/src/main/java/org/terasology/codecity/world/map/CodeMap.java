...
public interface CodeMap {
	 ...
	 * @param x Coordinate x to be used
	 * @param z Coordinate y to be used
	 * @return
	 */
	 ...
	 * @param z Coordinate z of the object
	 * @throws IllegalArgumentException if the object can't be added in position (x,z)
	 */
	public void insertContent(DrawableCode content, CodeScale scale, CodeMapFactory factory, int x, int z);

	/**
	 * Verify if the object can be placed in the given position
	 * @param content Object to be placed
	 * @param scale Scale to be used
	 * @param x x Coordinate x of the object
	 * @param z x Coordinate z of the object
	 * @return True if can be placed, false otherwise
	 */
	public boolean canPlaceContent(DrawableCode content, CodeScale scale, CodeMapFactory factory, int x, int z);
