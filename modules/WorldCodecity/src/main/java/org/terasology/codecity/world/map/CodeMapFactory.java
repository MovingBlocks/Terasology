...
public class CodeMapFactory {
	 ...
	 * @param scale Scale to be used in the generation of the map
	 */
	 ...
	 * @param contentList Content of the map
	...
	public CodeMap generateMap(List<DrawableCode> contentList) {
		...
		Collections.sort(contentList, new DrawableCodeSizeComparator(scale, this));
	 ...
	 * @param map Map where the object will be inserted
